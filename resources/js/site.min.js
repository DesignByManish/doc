! function($) {
    $.slidebars = function(t) {
        function e() {
            !u.disableOver || "number" == typeof u.disableOver && u.disableOver >= I ? (_ = !0, $("html").addClass("sb-init"), u.hideControlClasses && z.removeClass("sb-hide"), i()) : "number" == typeof u.disableOver && u.disableOver < I && (_ = !1, $("html").removeClass("sb-init"), u.hideControlClasses && z.addClass("sb-hide"), m.css("minHeight", ""), (g || b) && r())
        }

        function i() {
            m.css("minHeight", ""), m.css("minHeight", $("html").height() + "px"), y && y.hasClass("sb-width-custom") && y.css("width", y.attr("data-sb-width")), v && v.hasClass("sb-width-custom") && v.css("width", v.attr("data-sb-width")), y && (y.hasClass("sb-style-push") || y.hasClass("sb-style-overlay")) && y.css("marginLeft", "-" + y.css("width")), v && (v.hasClass("sb-style-push") || v.hasClass("sb-style-overlay")) && v.css("marginRight", "-" + v.css("width")), u.scrollLock && $("html").addClass("sb-scroll-lock")
        }

        function n(t, e, n) {
            var o;
            if (o = t.hasClass("sb-style-push") ? m.add(t).add(L) : t.hasClass("sb-style-overlay") ? t : m.add(L), "translate" === w) o.css("transform", "translate(" + e + ")");
            else if ("side" === w) "-" === e[0] && (e = e.substr(1)), "0px" !== e && o.css(n, "0px"), setTimeout(function() {
                o.css(n, e)
            }, 1);
            else if ("jQuery" === w) {
                "-" === e[0] && (e = e.substr(1));
                var r = {};
                r[n] = e, o.stop().animate(r, 400)
            }
            setTimeout(function() {
                "0px" === e && (o.css("left", "").css("transform", ""), i())
            }, 400)
        }

        function o(t, e) {
            function i() {
                _ && "left" === t && y ? ($("html").addClass("sb-active sb-active-left"), y.addClass("sb-active"), y.find("nav").transition({
                    opacity: 1
                }, 2e3), n(y, y.css("width"), "left"), setTimeout(function() {
                    g = !0, "function" == typeof e && e()
                }, 400)) : _ && "right" === t && v && ($("html").addClass("sb-active sb-active-right"), v.addClass("sb-active"), n(v, "-" + v.css("width"), "right"), setTimeout(function() {
                    b = !0, "function" == typeof e && e()
                }, 400))
            }
            "left" === t && y && b || "right" === t && v && g ? (r(), setTimeout(i, 400)) : i()
        }

        function r(t) {
            (g || b) && (g && (n(y, "0px", "left"), g = !1, y.find("nav").transition({
                opacity: 1
            })), b && (n(v, "0px", "right"), b = !1), setTimeout(function() {
                $("html").removeClass("sb-active sb-active-left sb-active-right"), y && y.removeClass("sb-active"), v && v.removeClass("sb-active"), "function" == typeof t && t()
            }, 400))
        }

        function s(t, e) {
            "left" === t && y && (g ? r(null, e) : o("left", e)), "right" === t && v && (b ? r(null, e) : o("right", e))
        }
        ...
        var u = $.extend({
            ...
            p = !1,
            f = !1;
        ("" === h.MozTransition || "" === h.WebkitTransition || "" === h.OTransition || "" === h.transition) && (p = !0), ("" === h.MozTransform || "" === h.WebkitTransform || "" === h.OTransform || "" === h.transform) && (f = !0);
        var c = navigator.userAgent,
            l = !1,
            d = !1;
        /Android/.test(c) ? l = c.substr(c.indexOf("Android") + 8, 3) : /(iPhone|iPod|iPad)/.test(c) && (d = c.substr(c.indexOf("OS ") + 3, 3).replace("_", ".")), (l && 3 > l || d && 5 > d) && $("html").addClass("sb-static");
        var m = $("#sb-site, .sb-site-container");
        if ($(".sb-left").length) var y = $(".sb-left"),
            g = !1;
        if ($(".sb-right").length) var v = $(".sb-right"),
            b = !1;
        var _ = !1,
            I = $(window).width(),
            z = $(".sb-toggle-left, .sb-toggle-right, .sb-open-left, .sb-open-right, .sb-close"),
            L = $(".sb-slide");
        e(), $(window).resize(function() {
            var t = $(window).width();
            I !== t && (I = t, e(), g && o("left"), b && o("right"))
        });
        var w;
        p && f ? (w = "translate", l && 4.4 > l && (w = "side")) : w = "jQuery", this.slidebars = {
            open: o,
            close: r,
            toggle: s,
            init: function() {
            ...
            resetCSS: i,
            active: function(t) {
                return "left" === t && y ? g : "right" === t && v ? b : void 0
            },
            destroy: function(t) {
                "left" === t && y && (g && r(), setTimeout(function() {
                    y.remove(), y = !1
                }, 400)), "right" === t && v && (b && r(), setTimeout(function() {
                    v.remove(), v = !1
                }, 400))
            }
        }, $(".sb-toggle-left").on("touchend click", function(t) {
            a(t, $(this)), s("left")
        }), $(".sb-toggle-right").on("touchend click", function(t) {
            a(t, $(this)), s("right")
        }), $(".sb-open-left").on("touchend click", function(t) {
            a(t, $(this)), o("left")
        }), $(".sb-open-right").on("touchend click", function(t) {
            a(t, $(this)), o("right")
        }), $(".sb-close").on("touchend click", function(t) {
            if ($(this).is("a") || $(this).children().is("a")) {
                if ("click" === t.type) {
                    t.preventDefault();
                    var e = $(this).is("a") ? $(this).attr("href") : $(this).find("a").attr("href");
                    r(function() {
                        window.location = e
                    })
                }
            } else a(t, $(this)), r()
        }), m.on("touchend click", function(t) {
            u.siteClose && (g || b) && (a(t, $(this)), r())
        })
    }
}(jQuery),
function(t) {
...
function() {
        ...
        function n(t) {
            function n(t) {
                if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var p = o.isBorderBox = !(!h || !n[h] || "border-box" !== n[h]), f = 0, c = s.length; c > f; f++) {
                        var l = s[f],
                            d = n[l];
                        d = a(t, d);
                        var m = parseFloat(d);
                    ...
                    var y = o.paddingLeft + o.paddingRight,
                        ...
                        I = o.borderTopWidth + o.borderBottomWidth,
                        z = p && u,
                        L = e(n.width);
                    L !== !1 && (o.width = L + (z ? 0 : y + _));
                    var w = e(n.height);
                    return w !== !1 && (o.height = w + (z ? 0 : g + I)), o.innerWidth = o.width - (y + _), o.innerHeight = o.height - (g + I), o.outerWidth = o.width + v, o.outerHeight = o.height + b, o
                }
            }
                ...
                return Object.create ? n.prototype = Object.create(y.prototype) : e(n.prototype, y.prototype), n.prototype.constructor = n, n.defaults = e({}, y.defaults), e(n.defaults, i), n.prototype.settings = {}, n.namespace = t, n.data = y.data, n.Item = function() {
                    ...
                    for (var e = r(t), i = a.querySelectorAll(".js-" + e), o = "data-" + e + "-options", s = 0, p = i.length; p > s; s++) {
                        ...
                        try {
                            ...
                            u && u.error("Error parsing " + o + " on " + c.nodeName.toLowerCase() + (c.id ? "#" + c.id : "") + ": " + d);
                            continue
                        }
                        var m = new n(c, f);
                        h && h.data(c, t, m)
    ...
    function(t) {
        ...
        function r(t, i, r, u, p) {
            ...
            c.Item = u, c.LayoutMode = p, c.prototype._create = function() {
                ...
                i = i || "*";
                for (var n = [], o = [], r = [], s = this._getFilterTest(i), a = 0, u = t.length; u > a; a++) {
                    var h = t[a];
                    if (!h.isIgnored) {
                        var p = s(h);
    ...
    function(t, e) {
        ...
        function i() {
            return f.style[c.transform] = "", f.style[c.transform] = "rotateY(90deg)", "" !== f.style[c.transform]
        }
        ...
        function r(e) {
            ...
            return t.each(e, function(e) {
                e = t.camelCase(e), e = t.transit.propertyMap[e] || t.cssProps[e] || e, e = u(e), c[e] && (e = u(c[e])), -1 === t.inArray(e, i) && i.push(e)
            }), i
        }
        ...
        function a(e, i) {
            i || (t.cssNumber[e] = !0), t.transit.propertyMap[e] = c.transform, t.cssHooks[e] = {
                get: function(i) {
        ...
        c.transition = e("transition"), c.transitionDelay = e("transitionDelay"), c.transform = e("transform"), c.transformOrigin = e("transformOrigin"), c.filter = e("Filter"), c.transform3d = i();
        var d = {
                transition: "transitionend",
                MozTransition: "transitionend",
                OTransition: "oTransitionEnd",
            ...
            m = c.transitionEnd = d[c.transition] || null;
        for (var y in c) c.hasOwnProperty(y) && "undefined" == typeof t.support[y] && (t.support[y] = c[y]);
        return f = null, t.cssEase = {
            ...
            set: function(e, i) {
                var o = i;
                o instanceof n || (o = new n(o)), e.style[c.transform] = "WebkitTransform" !== c.transform || l ? o.toString() : o.toString(!0), t(e).data("transform", o)
            }
        }, t.cssHooks.transform = {
            set: t.cssHooks["transit:transform"].set
        }, t.cssHooks.filter = {
            get: function(t) {
                return t.style[c.filter]
            },
            set: function(t, e) {
                t.style[c.filter] = e
            }
            ...
            toString: function(t) {
                ...
                for (var i in this)
                    if (this.hasOwnProperty(i)) {
                        if (!c.transform3d && ("rotateX" === i || "rotateY" === i || "perspective" === i || "transformOrigin" === i)) continue;
            ...
            var v = {},
                b = function(e) {
                    var i = !1,
                        n = function() {
                            i && a.unbind(m, n), y > 0 && a.each(function() {
                                this.style[c.transition] = v[this] || null
                            }), "function" == typeof r && r.apply(a), "function" == typeof e && e()
                        };
                    y > 0 && m && t.transit.useTransitionEnd ? (i = !0, a.bind(m, n)) : window.setTimeout(n, y), a.each(function() {
                        y > 0 && (this.style[c.transition] = l), t(this).css(f)
                    })
                },
                _ = function(t) {
    ...
    }), $.fn.dataImg = function(t) {
        function e(t) {
            var e = $(window).width();
            return t.data(e > n.med ? "lrg" : e <= n.med && e > n.sml ? "med" : "sml")
        }
        ...
        function i() {
            o.each(function() {
                var t = $(this),
                    i = e(t);
                void 0 != i && (t.is("img") ? t.attr("src", i) : t.css("background-image", "url(" + i + ")"))
            })
        }
        var n = $.extend({
                sml: 400,
            ...
            o = $(this);
        i(), 1 == n.resize && $(window).resize(function() {
            i()
        })
    };
var Global = {
        ...
        Navigation: function() {
            $.slidebars();
            var t = $("html").not(".sb-active").find(".nav");
            $(window).bind("resize orientationchange", function() {
                Modernizr.mq("only screen and (min-width: 1092px)") ? t.css("margin-left", ($("main >div, main >article").offset().left - 16) / 2 + "px") : t.css("margin-left", "")
            }), Modernizr.mq("only screen and (min-width: 1092px)") && t.css("margin-left", ($("main >div, main >article").offset().left - 16) / 2 + "px"), setTimeout(function() {
                t.transition({
                    opacity: 1
                }, 1200)
            }, 600)
    ...
    Homepage = {
        Init: function() {
            this.Isotope(), this.Filter(), this.ResponsiveImages(), this.Fade()
        },
        Isotope: function() {
            var t = "",
                e = $("#homepage >div");
            window.location.hash ? (t = window.location.hash.replace("#", "."), $("li.filter a[data-filter='" + t + "']").addClass("on")) : $("li.filter a[data-filter='']").addClass("on"), e.isotope({
                filter: t,
        ...
        Filter: function() {
            var t = "",
                e = $("#homepage >div");
            $("ul.nav-list li.filter").on("click", "a", function(i) {
                i.preventDefault(), t = $(this).attr("data-filter"), e.isotope({
                    filter: t
                }), window.location.hash = t.replace(".", ""), $("li.filter a").removeClass("on"), $(this).addClass("on")
            })
        },
        ResponsiveImages: function() {
            $("#homepage >div article img").dataImg({
                sml: 400,
                med: 800,
                lrg: 1e3,
                resize: !0
        ...
        Fade: function() {
            $("#homepage >div article a").each(function(t) {
                $(this).transition({
                    opacity: 1,
                    delay: 200 * t
                }, 1700)
    ...
    Content = {
        Init: function() {
            this.StickyNav(), this.ResponsiveImages()
        },
        StickyNav: function() {
            var t = $("#content nav");
            $(window).bind("scroll", function() {
                (Modernizr.mq("only screen and (min-width: 992px)") || $("html").hasClass("ie8")) && ($(window).scrollTop() > 80 ? t.addClass("scrolled") : t.removeClass("scrolled"))
            })
        },
        ResponsiveImages: function() {
            $("#content .images .data-img").dataImg({
                sml: 400,
                med: 800,
                lrg: 1e3,
                resize: !0
